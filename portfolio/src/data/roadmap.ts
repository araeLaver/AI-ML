...
export const profile: Profile = {
  ...
  targetSalary: "2억+ (글로벌 리모트 시 $200K-$300K)",
  timeline: "18개월",
};
...
export const portfolioProjects = [
  {
    id: 1,
    title: "금융 문서 RAG 시스템",
    description: "4가지 청킹 전략과 하이브리드 검색(Vector+BM25+RRF)을 적용한 금융 Q&A 시스템",
    tech: ["LangChain", "ChromaDB", "FastAPI", "Streamlit", "Groq"],
    features: ["하이브리드 검색", "Re-ranking", "실시간 금융데이터", "출처 명시"],
    status: "completed",
    github: "https://github.com/kdowney/finance-rag-api",
  },
  {
    id: 2,
    title: "자동 코드 리뷰 AI Agent",
    description: "LangGraph 기반 멀티 에이전트가 보안/성능/스타일을 병렬 분석하는 코드 리뷰 시스템",
    tech: ["LangGraph", "GitHub API", "FastAPI", "OpenAI", "Streamlit"],
    features: ["멀티 에이전트 병렬실행", "GitHub 웹훅", "AST 분석", "복잡도 측정"],
    status: "completed",
    github: "https://github.com/kdowney/code-review-agent",
  },
  {
    id: 3,
    title: "MLOps 파이프라인",
    description: "DVC 데이터 버전관리 + MLflow 실험추적 + K8s 배포 + Prometheus 모니터링",
    tech: ["MLflow", "DVC", "Kubernetes", "Prometheus", "Grafana", "GitHub Actions"],
    features: ["CI/CD 자동화", "드리프트 감지", "HPA 자동확장", "실험 추적"],
    status: "completed",
    github: "https://github.com/kdowney/mlops-pipeline",
  },
  {
    id: 4,
    title: "금융 이상탐지 + LLM 분석",
    description: "ML 기반 이상거래 탐지와 LLM을 활용한 거래 패턴 분석 시스템",
    tech: ["scikit-learn", "OpenAI", "Claude", "Streamlit", "Pandas"],
    features: ["Isolation Forest", "Function Calling", "CoT 프롬프팅", "거래 해석"],
    status: "completed",
    github: "https://github.com/kdowney/financial-analysis",
  },
  {
    id: 5,
    title: "금융 도메인 LLM Fine-tuning",
    description: "LoRA/QLoRA를 활용한 금융 특화 LLM 파인튜닝 (100+ 데이터셋)",
    tech: ["PyTorch", "Transformers", "PEFT", "BitsAndBytes", "FastAPI"],
    features: ["LoRA/QLoRA", "4-bit 양자화", "금융 데이터셋", "추론 API"],
    status: "completed",
    github: "https://github.com/kdowney/financial-finetuning",
  },
];
